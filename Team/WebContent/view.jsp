...
<body>
	...
	<section>
		...
		<div class="container">
			...
			<div class="content">
				<%
					if (dto.getBfileReal() == null) {
				%>
				<p><%=dto.getbContent()%></p>
				<%
					} else {
				%>
				<img src="/Team/upload/<%=dto.getBfileReal()%>" style="width: 300px">
				<p><%=dto.getbContent()%></p>
			</div>
			<%
				}
			...
			<form class="like" method="post" action="like.go">
				...
				<%
					bbsDAO dao = new bbsDAO();
						ArrayList<bbsDTO> Llist = dao.getList(pageNumber);
	...
	<section>
		...
		<div class="container">
			...
			%>
			<a href="writeRevise.jsp?bID=<%=bID%>" class="reviseBtn">수정</a>
			<form class="delete" method="post" action="delete.go">
